    ...
    var t = 0,
        ...
        r = {
                ...
                e("#fn__chat_textarea").length && !e(".techwave_fn_intro").length && e("#fn__chat_textarea").focus(), e("#fn__chat_textarea").keypress(function(t) {
                    ...
                    if (!("" === o || t.hasClass("disabled"))) {
                        ...
                        var n = e(".fn__chatbot .chat__item.active"),
                            i = '<div class="chat__box your__chat"><div class="author"><span>Amir Hossein Gholami</span></div><div class="chat"><p>' + o + "</p></div></div>";
            ...
            frenifyChat: function() {
                ...
                var l = "<p>Hello.</p><p>I am an artificial intelligence that was created and designed by the youth of Iran and I help the country's education as an assistant. If you have a question, ask?</p>";
                n.welcome.text = l;
                ...
                c && (t = '<p>Hello dear user, I am artificial intelligence,\'I am ready to serve you. I hope we will have a good time together\'</p>Do you have a question for me?'), a && (e(".fn__chat_comment button").addClass("disabled"), setTimeout(function() {
                    e(".fn__chatbot .chat__item.active").append('<div class="chat__box bot__chat"><div class="author"><span>Chat Bot</span></div><div class="chat"><frenify_typing><h3><span>Typing...</frenify></h3></div></div>'), e(".techwave_fn_intro").length ? e("html, body").animate({
