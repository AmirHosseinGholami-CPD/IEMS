    ...
    var t = 0,
        ...
        r = {
                ...
                e("#fn__chat_textarea").length && !e(".techwave_fn_intro").length && e("#fn__chat_textarea").focus(), e("#fn__chat_textarea").keypress(function(t) {
                    ...
                    if (!("" === o || t.hasClass("disabled"))) {
                        ...
                        var n = e(".fn__chatbot .chat__item.active"),
                            i = '<div class="chat__box your__chat"><div class="author"><span>امیر حسین غلامی</span></div><div class="chat"><p>' + o + "</p></div></div>";
            ...
            frenifyChat: function() {
                ...
                var l = "<p>سلام</p><p>من هوش مصنوعی هستم که توسط قشر نوجوان ایران زمین ساخته و طراحی شده ام و به عنوان دستیار به تحصیل کشور کمک میکنم. اگه سوالی داشتید بپرسید؟</p>";
                n.welcome.text = l;
                ...
                c && (t = '<p>سلام بر شما من هوش مصنوعی هستم,\و آماده خدمت کردن به شما هستم.  خیلی خوشحال هستم که باهم وقت بگذرونیم\</p>آیا سوای دارید؟'), a && (e(".fn__chat_comment button").addClass("disabled"), setTimeout(function() {
                    e(".fn__chatbot .chat__item.active").append('<div class="chat__box bot__chat"><div class="author"><span>چت بات</span></div><div class="chat"><frenify_typing><h3><span>در حال نوشتن...</frenify></h3></div></div>'), e(".techwave_fn_intro").length ? e("html, body").animate({
            ...
            aiChatBotOptions: function() {
                e(".fn__chat_link").off().on("click", function() {
                    ...
                    var t = e(this);
                    return t.hasClass("active") || (e(".fn__chat_link.active").removeClass("active"), e(".fn__chatbot .chat__item.active").removeClass("active"), t.addClass("active"), e(t.attr("href")).addClass("active"), i = 0, e(".fn__chatbot .fn__title_holder .title").text("چت جدید")), e(".fn__chat_comment").addClass("neww"), e("#fn__chat_textarea").frenifyMoveCursorToEnd(), !1
