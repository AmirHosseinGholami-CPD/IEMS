...
(function(e) {
    ...
    e.fn.parallax = function(r, i, s) {
        ...
        if (s) { u = function(e) { return e.outerHeight(true) } } else { u = function(e) { return e.height() } }
...
! function(e) { "function" == typeof define && define.amd ? define(["jquery"], e) : e("object" == typeof exports ? require("jquery") : window.jQuery || window.Zepto) }((function(e) {
    ...
    h.prototype = {
        ...
        open: function(n) {
            if (!1 === n.isObj) {
                ...
                for (o = 0; o < s.length; o++)
                    if ((r = s[o]).parsed && (r = r.el[0]), r === n.el[0]) { t.index = o; break }
            ...
            if (!t.isOpen) {
                ...
                return t.isIE7 && (v += " mfp-ie7"), v && t._addClassToMFP(v), t.updateItemHTML(), b("BuildControls"), e("html").css(g), t.bgOverlay.add(t.wrap).prependTo(t.st.prependTo || e(document.body)), t._lastFocusedEl = document.activeElement, setTimeout((function() { t.content ? (t._addClassToMFP(f), t._setFocus()) : t.bgOverlay.addClass(f), i.on("focusin" + p, t._onFocusIn) }), 16), t.isOpen = !0, t.updateSize(m), b(d), n
            }
            t.updateItemHTML()
        },
        close: function() { t.isOpen && (b(l), t.isOpen = !1, t.st.removalDelay && !t.isLowIE && t.supportsTransition ? (t._addClassToMFP(m), setTimeout((function() { t._close() }), t.st.removalDelay)) : t._close()) },
        _close: function() {
            b(s);
            var n = m + " " + f + " ";
        ...
        appendContent: function(e, n) { t.content = e, e ? t.st.showCloseBtn && t.st.closeBtnInside && !0 === t.currTemplate[n] ? t.content.find(".mfp-close").length || t.content.append(I()) : t.content = e : t.content = "", b("BeforeAppend"), t.container.addClass("mfp-" + n + "-holder"), t.contentContainer.append(t.content) },
        parseEl: function(n) {
            var i, o = t.items[n];
        ...
        updateStatus: function(e, i) {
            if (t.preloader) {
                ...
                b("UpdateStatus", o), e = o.status, i = o.text, t.preloader.html(i), t.preloader.find("a").on("click", (function(e) { e.stopImmediatePropagation() })), t.container.addClass("mfp-s-" + e), n = e
            }
        },
        ...
        _hasScrollBar: function(e) { return (t.isIE7 ? i.height() : document.body.scrollHeight) > (e || y.height()) },
        _setFocus: function() {
        ...
        _parseMarkup: function(t, n, i) {
            var o;
            i.data && (n = e.extend(i.data, n)), b(c, [t, n, i]), e.each(n, (function(e, n) { if (void 0 === n || !1 === n) return !0; if ((o = e.split("_")).length > 1) { var i = t.find(p + "-" + o[0]); if (i.length > 0) { var a = o[1]; "replaceWith" === a ? i[0] !== n[0] && i.replaceWith(n) : "img" === a ? i.is("img") ? i.attr("src", n) : i.replaceWith('<img src="' + n + '" class="' + i.attr("class") + '" />') : i.attr(o[1], n) } } else t.find(p + "-" + e).html(n) }))
        },
    ...
    e.magnificPopup.registerModule(_, {
        ...
        proto: {
            initInline: function() { t.types.push(_), C(s + "." + _, (function() { S() })) },
    ...
    e.magnificPopup.registerModule(O, {
        ...
        proto: {
            initAjax: function() { t.types.push(O), P = t.st.ajax.cursor, C(s + "." + O, M), C("BeforeChange." + O, M) },
            getAjax: function(n) {
                ...
                var i = e.extend({
                    ...
                    success: function(i, o, a) {
                        var r = { data: i, xhr: a };
                        b("ParseAjax", r), t.appendContent(e(r.data), O), n.finished = !0, z(), t._setFocus(), setTimeout((function() { t.wrap.addClass(f) }), 16), t.updateStatus("ready"), b("AjaxContentAdded")
                    },
                    error: function() { z(), n.finished = n.loadError = !0, t.updateStatus("error", t.st.ajax.tError.replace("%url%", n.src)) }
                }, t.st.ajax.settings);
                return t.req = e.ajax(i), ""
            }
        }
    });
    var B, F, H = function(n) { if (n.data && void 0 !== n.data.title) return n.data.title; var i = t.st.image.titleSrc; if (i) { if (e.isFunction(i)) return i.call(t, n); if (n.el) return n.el.attr(i) || "" } return "" };
    e.magnificPopup.registerModule("image", {
        ...
        proto: {
            initImage: function() {
                var n = t.st.image,
                    i = ".image";
                t.types.push("image"), C(d + i, (function() { "image" === t.currItem.type && n.cursor && e(document.body).addClass(n.cursor) })), C(s + i, (function() { n.cursor && e(document.body).removeClass(n.cursor), y.off("resize" + p) })), C("Resize" + i, t.resizeImage), t.isLowIE && C("AfterChange", t.resizeImage)
            },
            ...
            _onImageHasSize: function(e) { e.img && (e.hasSize = !0, B && clearInterval(B), e.isCheckingImgSize = !1, b("ImageHasSize", e), e.imgHidden && (t.content && t.content.removeClass("mfp-loading"), e.imgHidden = !1)) },
                ...
                if (n.enabled && t.supportsTransition) {
                    ...
                    C("BuildControls" + i, (function() {
                        if (t._allowZoom()) {
                            ...
                            (a = c(e)).css(t._getOffset()), t.wrap.append(a), o = setTimeout((function() { a.css(t._getOffset(!0)), o = setTimeout((function() { d(), setTimeout((function() { a.remove(), e = a = null, b("ZoomAnimationEnded") }), 16) }), r) }), 16)
                        }
                    })), C(l + i, (function() {
                        if (t._allowZoom()) {
                    ...
                    })), C(s + i, (function() { t._allowZoom() && (d(), a && a.remove(), e = null) }))
                }
            },
    ...
    e.magnificPopup.registerModule(L, {
        ...
        proto: {
            initIframe: function() { t.types.push(L), C("BeforeChange", (function(e, t, n) { t !== n && (t === L ? A() : n === L && A(!0)) })), C(s + "." + L, (function() { A() })) },
    ...
    var j = function(e) { var n = t.items.length; return e > n - 1 ? e - n : 0 > e ? n + e : e },
        N = function(e, t, n) { return e.replace(/%curr%/gi, t + 1).replace(/%total%/gi, n) };
    e.magnificPopup.registerModule("gallery", {
        options: { enabled: !1, arrowMarkup: '<button title="%title%" type="button" class="mfp-arrow mfp-arrow-%dir%"><span class="visually-hidden">%title%</span></button>', preload: [0, 2], navigateByImgClick: !0, arrows: !0, tPrev: "Previous (Left arrow key)", tNext: "Next (Right arrow key)", tCounter: "%curr% of %total%" },
        proto: {
            initGallery: function() {
                var n = t.st.gallery,
                    o = ".mfp-gallery",
                    r = Boolean(e.fn.mfpFastClick);
                return t.direction = !0, !!n && !!n.enabled && (a += " mfp-gallery", C(d + o, (function() { n.navigateByImgClick && t.wrap.on("click" + o, ".mfp-img", (function() { return t.items.length > 1 ? (t.next(), !1) : void 0 })), i.on("keydown" + o, (function(e) { 37 === e.keyCode ? t.prev() : 39 === e.keyCode && t.next() })) })), C("UpdateStatus" + o, (function(e, n) { n.text && (n.text = N(n.text, t.currItem.index, t.items.length)) })), C(c + o, (function(e, i, o, a) {
                    ...
                    if (t.items.length > 1 && n.arrows && !t.arrowLeft) {
                        ...
                        o[s]((function() { t.prev() })), a[s]((function() { t.next() })), t.isIE7 && (w("b", o[0], !1, !0), w("a", o[0], !1, !0), w("b", a[0], !1, !0), w("a", a[0], !1, !0)), t.container.append(o.add(a))
                    }
                })), C(u + o, (function() { t._preloadTimeout && clearTimeout(t._preloadTimeout), t._preloadTimeout = setTimeout((function() { t.preloadNearbyImages(), t._preloadTimeout = null }), 16) })), void C(s + o, (function() { i.off(o), t.wrap.off("click" + o), t.arrowLeft && r && t.arrowLeft.add(t.arrowRight).destroyMfpFastClick(), t.arrowRight = t.arrowLeft = null })))
            },
            next: function() { t.direction = !0, t.index = j(t.index + 1), t.updateItemHTML() },
            prev: function() { t.direction = !1, t.index = j(t.index - 1), t.updateItemHTML() },
            ...
            _preloadItem: function(n) {
                if (n = j(n), !t.items[n].preloaded) {
                    var i = t.items[n];
                    i.parsed || (i = t.parseEl(n)), b("LazyLoad", i), "image" === i.type && (i.img = e('<img class="mfp-img" />').on("load.mfploader", (function() { i.hasSize = !0 })).on("error.mfploader", (function() { i.hasSize = !0, i.loadError = !0, b("LazyLoadError", i) })).attr("src", i.src)), i.preloaded = !0
                }
            }
        }
    });
        ...
        proto: {
            initRetina: function() {
                if (window.devicePixelRatio > 1) {
                    var e = t.st.retina,
                        n = e.ratio;
                    (n = isNaN(n) ? n() : n) > 1 && (C("ImageHasSize." + q, (function(e, t) { t.img.css({ "max-width": t.img[0].naturalWidth / n, width: "100%" }) })), C("ElementParse." + q, (function(t, i) { i.src = e.replaceSrc(i, n) })))
                }
            }
        }
    }), W = "ontouchstart" in window, R = function() { y.off("touchmove" + Z + " touchend" + Z) }, Z = ".mfpFastClick", e.fn.mfpFastClick = function(t) {
        return e(this).each((function() {
            var n, i, o, a, r, s, l, c = e(this);
            W && c.on("touchstart" + Z, (function(e) { a = !1, s = 1, i = (r = e.originalEvent ? e.originalEvent.touches[0] : e.touches[0]).clientX, o = r.clientY, y.on("touchmove" + Z, (function(e) { s = (r = e.originalEvent ? e.originalEvent.touches : e.touches).length, r = r[0], (Math.abs(r.clientX - i) > 10 || Math.abs(r.clientY - o) > 10) && (a = !0, R()) })).on("touchend" + Z, (function(e) { R(), a || s > 1 || (l = !0, e.preventDefault(), clearTimeout(n), n = setTimeout((function() { l = !1 }), 1e3), t()) })) })), c.on("click" + Z, (function() { l || t() }))
        }))
    }, e.fn.destroyMfpFastClick = function() { e(this).off("touchstart" + Z + " click" + Z), W && y.off("touchmove" + Z + " touchend" + Z) }, x()
}));
...
! function(t, e) {
    ...
    var a, r, l = function() {
        ...
        f = function() {
            ...
            return l(t, [{ key: "init", value: function() { this.element = window.document.documentElement, i(document.readyState, ["interactive", "complete"]) ? this.start() : s(document, "DOMContentLoaded", this.start), this.finished = [] } }, {
                key: "start",
                value: function() {
                    var t = this;
            ...
            }, { key: "stop", value: function() { this.stopped = !0, o(this.config.scrollContainer || window, "scroll", this.scrollHandler), o(window, "resize", this.scrollHandler), null != this.interval && clearInterval(this.interval) } }, { key: "sync", value: function() { h.notSupported && this.doSync(this.element) } }, {
                key: "doSync",
                value: function(t) {
                ...
                value: function(t, e) {
                    ...
                    return this.animate(function() { return n.customStyle(t, e, i, s, o) })
                }
            }, { key: "resetStyle", value: function() { for (var t = 0; t < this.boxes.length; t++) this.boxes[t].style.visibility = "visible" } }, { key: "resetAnimation", value: function(t) { t.type.toLowerCase().indexOf("animationend") >= 0 && (t.target || t.srcElement) } }, { key: "customStyle", value: function(t, e, n, i, s) { return e && this.cacheAnimationName(t), t.style.visibility = "visible", n && this.vendorSet(t.style, { animationDuration: n }), i && this.vendorSet(t.style, { animationDelay: i }), s && this.vendorSet(t.style, { animationIterationCount: s }), this.vendorSet(t.style, { animationName: e ? "none" : this.cachedAnimationName(t) }), t } }, {
                key: "vendorSet",
                value: function(t, e) {
                    for (var n in e)
            ...
            }, { key: "disabled", value: function() { var t; return !this.config.mobile && (t = navigator.userAgent, /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(t)) } }]), t
        }();
...
TxtType.prototype.tick = function() {
    ...
    this.isDeleting && (s /= 5), this.isDeleting || this.txt !== e ? this.isDeleting && "" === this.txt && (this.isDeleting = !1, this.loopNum++, s = 500) : (s = this.period, this.isDeleting = !0), setTimeout((function() { i.tick() }), s)
...
/* ---------------------------------------------
 ...
 --------------------------------------------- */
! function() {
    var e, t, o, n, r = { frameRate: 150, animationTime: 500, stepSize: 100, pulseAlgorithm: !0, pulseScale: 4, pulseNormalize: 1, accelerationDelta: 50, accelerationMax: 3, keyboardSupport: !0, arrowScroll: 50, fixedBackground: !0, excluded: "" },
        a = r,
        l = !1,
        i = !1,
        c = { x: 0, y: 0 },
    ...
    e[o + "filter"] = e[o + "filter"] || "", t = setUnit(t > jQuery.CSS.filters[r].max ? jQuery.CSS.filters[r].max : t, jQuery.CSS.filters[r].unit), e[o + "filter"] += a + "(" + t + ") ", delete e[r]
        ...
        animate: function(e, r, t, a, o) {
            return this.each(function() {
                ...
                if (i.CSSAIsRunning && i.eventType == s.type && !jQuery.mbBrowser.msie && 9 >= jQuery.mbBrowser.version) i.CSSqueue = function() { l.CSSAnimate(e, r, t, a, o) };
